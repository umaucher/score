...
.. req:: SUP.9.BP1: Identify and record the problem
   :id: R_ASPICE-40_SUP-9-BP1
   :status: valid
   :links: R_ASPICE-40_IIC-13-07
...
.. req:: SUP.9.BP2: Determine the cause and the impact of the problem
   :id: R_ASPICE-40_SUP-9-BP2
   :status: valid
   :links: R_ASPICE-40_IIC-13-07, R_ASPICE-40_IIC-15-55
...
.. req:: SUP.9.BP3: Authorize urgent resolution action
   :id: R_ASPICE-40_SUP-9-BP3
   :status: valid
   :links: R_ASPICE-40_IIC-13-07

   Obtain authorization for immediate action if a problem requires an urgent resolution according to the categorization.

.. req:: SUP.9.BP4: Raise alert notifications
   :id: R_ASPICE-40_SUP-9-BP4
   :status: valid
   :links: R_ASPICE-40_IIC-13-07
...
.. req:: SUP.9.BP5: Initiate problem resolution
   :id: R_ASPICE-40_SUP-9-BP5
   :status: valid
   :links: R_ASPICE-40_IIC-13-07
...
.. req:: SUP.9.BP6: Track problems to closure
   :id: R_ASPICE-40_SUP-9-BP6
   :status: valid
   :links: R_ASPICE-40_IIC-13-07, R_ASPICE-40_IIC-15-12
...
.. req:: SUP.9.BP7: Report the status of problem resolution activities
   :id: R_ASPICE-40_SUP-9-BP7
   :status: valid
   :links: R_ASPICE-40_IIC-15-12
