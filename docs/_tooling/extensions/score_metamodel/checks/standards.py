...
@graph_check
def DISABLED_check_all_standard_req_linked_item_via_the_compliance_req(
...
@graph_check
def DISABLED_check_all_standard_workproducts_linked_item_via_the_compliance_wp(
    app: Sphinx, needs: list[NeedsInfoType], log: CheckLogger
):
    """
...
@graph_check
def DISABLED_check_workproduct_uniqueness_over_workflows(
    app: Sphinx, needs: list[NeedsInfoType], log: CheckLogger
):
    """
