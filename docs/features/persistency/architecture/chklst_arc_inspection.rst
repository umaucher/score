...
.. list-table:: Feature Architecture Design Review Checklist Persistency
    :header-rows: 1
    ...
    * - ARC_01_01
      ...
      - `Issue for Findings <https://github.com/eclipse-score/score/issues/1992>`_
    * - ARC_01_02
    ...
    * - ARC_02_01
      ...
      - No
      - There is no component architecture available for persistency
      - `Issue for Findings <https://github.com/eclipse-score/score/issues/1992>`_
    * - ARC_02_02
      ...
      - No
      - Are these interfaces names, any operations? Please update template.
      - `Issue for Findings <https://github.com/eclipse-score/score/issues/1992>`_
    * - ARC_02_03
