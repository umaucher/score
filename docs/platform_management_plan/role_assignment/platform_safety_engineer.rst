...
Platform Safety Engineer Election
*********************************

.. document:: Platform Safety Engineer
   :id: doc__platform_safety_engineer
   :status: valid
   :safety: ASIL_B
   :security: YES
...
For the platform safety management a pool of safety engineers is elected due to complexity of the task:
...
For the role :need:`rl__safety_engineer` the required skills, knowledge and experience is defined in :need:`rl__safety_engineer`.
