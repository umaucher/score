...
solve at least some of the problems through the standartization. Eclipse S-CORE project by no way contradicts to the ideas of Autosar. Furthermore
...
the standartization, that we try to achieve with the Eclipse S-CORE project are the following:
