...
Purpose
+++++++
The purpose of the Problem Resolution Process is to guide the resolution of problems
...
* Problem resolution are initiated and tracked to closure and status of Problem resolution is
...
* 1. Create the Problem report
* 2. Analyse the Problem report
* 3. Initiate and Monitor the Problem resolution
...
The figure below shows the workflow for the simplest case of a problem report.
...
If this is the case the ISSUE status is set to ``Closed`` and the Projects status is set to ``Done``.
